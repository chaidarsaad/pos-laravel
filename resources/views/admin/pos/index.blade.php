                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($positems as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ url('update-pointofsale/' . $item->id) }}"
                                                            method="post">
                                                            @method('PUT')
                                                            @csrf
                                                            <div class="row">
                                                                <div class="input-group mb-1">
                                                                    <input type="number" class="form-control"
                                                                        placeholder="Jumlah" name="prod_qty"
                                                                        value="{{ $item->prod_qty }}">
                                                    ...
                                                    <td>
                                                        <a href="{{ url('delete-pointofsale/' . $item->id) }}"
                                ...
                                <form action="{{ url('checkout-pos') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <input required placeholder="nama costumer" type="text" name="fname"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <input required placeholder="Uang Bayar" type="number" name="bayar"
                                                class="form-control">
                                        </div>
